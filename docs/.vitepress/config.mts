    ...
    sidebar: {
      '/knowledge/': [
        ...
        { text: 'AI', items: [
          ...
          { text: 'FlashAttention 阅读导览', link: '/knowledge/ai/flash-attention-reading-guide' },
          { text: 'FlashAttention 术语表与状态', link: '/knowledge/ai/flash-attention-glossary-and-state-table' },
          { text: 'FlashAttention 系统地图', link: '/knowledge/ai/flash-attention-system-map' },
          { text: 'FlashAttention 源码精读', link: '/knowledge/ai/flash-attention-source-reading' },
          { text: 'FlashAttention 接口与 Autograd', link: '/knowledge/ai/flash-attention-interface-and-autograd' },
          { text: 'FlashAttention Kernel 与 Launch 机制', link: '/knowledge/ai/flash-attention-kernel-and-launch' },
          { text: 'FlashAttention Kernel 细节补充', link: '/knowledge/ai/flash-attention-kernel-details' },
          { text: 'FlashAttention PyTorch ATen 接入层', link: '/knowledge/ai/flash-attention-pytorch-aten-integration' },
