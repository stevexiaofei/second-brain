...
>
> **定位与边界：** 本文是 [NVIDIA CUDA 硬件与编程模型研究地图](./cuda-hardware-and-programming-model-map.md) 的入门实验补充，不是其重复副本：前者组织待验证的硬件与性能研究问题，本文组织从最小代码到测量的学习路径。实验、官方文档和 profiler 尚未逐项核验前，两篇都继续留在 Inbox。
