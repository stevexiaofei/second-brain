...
created: 2026-08-25
updated: 2026-09-03
source: 上交所/深交所上市公司年报准则、CFA 财务分析、巴菲特致股东信、张新民《从报表看企业》、财务造假案例；DeepSeek 分享对话（仅恢复并确认核心术语关系，完整对话未恢复）
---
...
> **本次补充的已验证要点**：从 DeepSeek 分享页恢复的内容确认了以下三个概念及其核心关系；完整对话未能恢复。下文的合并报表说明用于补足阅读语境，不是对原对话的逐字记录。

合并利润表中的净利润还要按股东归属拆分：

$$
\text{净利润} = \text{归属于母公司股东的净利润} + \text{少数股东损益}
$$

| 报表项目 | 常用简称 | 含义 |
|---|---|---|
| 净利润 | 净利润 | 合并主体在完成合并调整和内部交易抵销后实现的整体利润 |
| 归属于母公司股东的净利润 | 归母净利润 | 合并净利润中归属于上市公司母公司股东的部分 |
| 少数股东损益 | 少数股东损益 | 合并范围内子公司净利润中归属于非母公司股东的部分 |

少数股东损益是**当期利润的归属**；少数股东权益则是资产负债表中**净资产的归属**，两者不能混为一谈。

**简化示例 / 理解框架**：上市公司持有一家子公司 $80\%$ 的股权，外部股东持有 $20\%$；若合并口径净利润为 $100$，忽略其他业务和复杂合并调整时，可以理解为约 $80$ 归母、约 $20$ 归少数股东。重点不是机械套用比例，而是理解顺序：**先按控制口径合并，再按股东归属拆分**。实际金额应以合并利润表、持股比例、合并范围和相关附注为准。

#### 怎么看

1. 做历史比较、同业比较或估值时，净利润、归母净利润、扣非归母净利润等分子口径必须保持一致，并在计算中写明。
2. 阅读每股收益（EPS）、市盈率（P/E）和面向上市公司普通股股东的 ROE 时，先核对是否采用归母口径。
3. 少数股东损益较大或变化明显时，回查重要子公司的持股结构、合并范围变动和相关附注；它提示需要解释的口径差异，但不能单独据此断定异常或利益输送。
4. 归母净利润仍是权责发生制下的会计利润归属，不等于公司已经收到的现金、可立即分红的现金或股东已收到的股息；还要结合经营现金流判断利润质量。
...
- **归母净利润 vs 净利润**：合并净利润还需按母公司股东与少数股东归属拆分；口径关系和阅读重点见[净利润、归母净利润与少数股东损益](#净利润归母净利润与少数股东损益)。
...
| 净利润就是上市公司股东全部可归属的利润 | 合并净利润还要区分归母净利润和少数股东损益；分析面向普通股股东的指标时，先核对分子口径 |
...
- 需结合具体年报核对少数股东损益、少数股东权益、合并范围变化、每股收益与估值口径之间的实际对应关系；本次 DeepSeek 分享对话完整上下文未恢复

## Related Knowledge

- [价值投资学习路线图](./value-investing-learning-roadmap.md) — 本文是路线图“验证财报与治理”阶段的实操依据
